...
def forwardMulti = 
    ...
    import scalagrad.auto.forward.breeze.BreezeDoubleForwardMode.algebra.*
    ...
    val a = BreezeDoubleForwardMode.algebraDSL
...
def reverseMulti = 
    ...
    import scalagrad.auto.reverse.breeze.BreezeDoubleReverseMode.algebra.*
    import scalagrad.api.reverse.dual.*

    val a = BreezeDoubleReverseMode.algebraDSL
...
def forward = 
    ...
    val dgWithTypeDependency = ScalaGrad.derive(gWithTypeDependency(using BreezeDoubleForwardMode.algebraDSL))
...
def reverse = 
    ...
    val alg = BreezeDoubleReverseMode.algebraDSL
